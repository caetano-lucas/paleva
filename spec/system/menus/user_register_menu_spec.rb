...
describe 'usuario cadastra um novo cardápio' do
  ...
  it 'com sucesso' do
    ...
    _drink1 = Drink.create!(name: 'Coca-cola', description: 'Zero', alcohol: false, restaurant: restaurant)
    _drink2 = Drink.create!(name: 'Cerveja Bavária', description: '-4°', alcohol: true, restaurant: restaurant)
  ...
  it 'com nome único, com sucesso' do
    ...
    _drink1 = Drink.create!(name: 'Coca-cola', description: 'Zero', alcohol: false, restaurant: restaurant)
    _drink2 = Drink.create!(name: 'Cerveja Bavária', description: '-4°', alcohol: true, restaurant: restaurant)
    _menu = Menu.create!(name: 'Janta', restaurant: restaurant)
  ...
  it 'com pratos e bebidas, mostrando as porções' do
    ...
    _portion1 = Portion.create!(description: 'Meia porção - 3 pessoas', price_whole: 45, price_cents: 99, portionable_type: 'Dish', portionable_id: dish1.id) 
    _portion2 = Portion.create!(description: 'Inteira - 6 pessoas', price_whole: 79, price_cents: 99, portionable_type: 'Dish', portionable_id: dish1.id) 
  ...
  it 'sem sucesso se for funcionário' do
    cpf1 = CPF.generate(true).split
    cpf2 = CPF.generate(true).split
    cnpj1 = CNPJ.generate(true).split
    user_one = User.create!(email: 'userone@email.com',first_name: 'userone',
